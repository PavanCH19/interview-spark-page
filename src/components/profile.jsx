...
const ProfileEditor = () => {
    ...
    const handleGlobalSave = () => {
        ...
        axios.post('http://localhost:3000/api/auth/updateUserDetails', userData, {
            headers: { 'Authorization': token }
        })
            .then((res) => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50 p-4 md:p-8">
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                {/* Global Save Button - Fixed at top */}
                <div className="  z-50 flex justify-end">
                    <button
                        onClick={handleGlobalSave}
                        className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-8 py-3 rounded-xl hover:from-blue-700 hover:to-indigo-700 transition shadow-lg hover:shadow-xl flex items-center gap-3 font-semibold"
                    >
